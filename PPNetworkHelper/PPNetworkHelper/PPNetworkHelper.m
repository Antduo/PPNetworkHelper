...
+ (NSURLSessionTask *)GET:(NSString *)URL
    ...
    NSURLSessionTask *sessionTask = [_sessionManager GET:URL parameters:parameters headers:_sessionManager.requestSerializer.HTTPRequestHeaders progress:^(NSProgress * _Nonnull uploadProgress) {
...
+ (NSURLSessionTask *)POST:(NSString *)URL
    ...
    NSURLSessionTask *sessionTask = [_sessionManager POST:URL parameters:parameters headers:_sessionManager.requestSerializer.HTTPRequestHeaders progress:^(NSProgress * _Nonnull uploadProgress) {
...
+ (NSURLSessionTask *)uploadFileWithURL:(NSString *)URL
    ...
    NSURLSessionTask *sessionTask = [_sessionManager POST:URL parameters:parameters headers:_sessionManager.requestSerializer.HTTPRequestHeaders constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
        NSError *error = nil;
